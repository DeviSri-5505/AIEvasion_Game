...
try:
    # Ensure this matches your file name: background.jpeg
...
try:
    # Ensure this matches your file name: logo.png
    original_logo_image = pygame.image.load("logo.png").convert_alpha() # Use convert_alpha for PNG transparency
except pygame.error as e:
...
# If logo.png still has a white/black box after convert_alpha(), uncomment the line below
# logo_image.set_colorkey((0, 0, 0)) # Use (255, 255, 255) for white, (0, 0, 0) for black background
...
try:
    # Ensure this matches your file name: player.jpeg
...
# Set colorkey for Player image (assuming white background for JPEG)
...
while running:
    if game_over:
        ...
        # Display Final Score on Game Over screen (Orange)
    ...
    # Display Current Score during game (Orange)
